...
from AutomatedLiteraryCritique.schemas import EvaluationRecord
import asyncio
...
if __name__ == "__main__":
    # Test
    title, story = helper_functions.read_story("/Stories/The Apple that Whispered Fire_improved.txt")
    # print("Title:", title)
    # print("Story:\n", story)

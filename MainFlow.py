...
def mainFlow():
    ...
    for i in range(2):
        ...
        report_file_path = helper_functions.save_evaluation_report_to_file(result["story_id"], result["story_title"],
                                                                           result["raw_response"])
        ...
        improved_report_file_path = helper_functions.save_evaluation_report_to_file(result["story_id"],
                                                                                    result["story_title"],
                                                                                    result["raw_response"])
